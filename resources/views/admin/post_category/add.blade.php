...
@section('content')
    <main id="content" role="main" class="main">
        {!! html()->form('POST', route('admin_post_category_store'))->class('validasi')->attributes(['novalidate'])->open() !!}
        <!-- Content -->
                        ...
                        <div class="row">
                            ...
                            <div class="card col-lg-5">
                                <div class="card-body">
                                    ...
                                    ->attributes(['required','onchange' => 'updateSlug(null,null,this->value,"post_categories")']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <label class="toggle-switch" for="view_home">
                                            ...
                                            <span class="col-4 col-sm-3">
                                                {!! html()->input('checkbox', 'view_home')->class('toggle-switch-input')->id('view_home')->checked() !!}
                                                <span class="toggle-switch-label ml-auto">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </span>
                                        ...
                                        <div class="col-lg-7">
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'name[' . $val->abbr . ']')->class('form-control')->id('name')->placeholder('Tên danh mục')->aria('label', 'Tên danh mục')
                                                    ->attributes(['required', 'onchange' => "updateSlug(null,this.value,null,'post_categories')"]) !!}
                                                    {!! html()->div()->class('invalid-tooltip')->open() !!}
