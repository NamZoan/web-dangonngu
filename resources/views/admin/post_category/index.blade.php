                    ...
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox" style="min-width: 0px">
                            ...
                            <li style="display:flex;justify-content:center;align-items: center;margin-left: 10px;"><a
                                    class="" href="{{ route('admin_post_category_add') }}"><i class="fa fa-plus"
            ...
            $('#datatable1').DataTable({
                ...
                fnServerData: function(sSource, aoData, fnCallback, oSettings) {
                    ...
                    oSettings.jqXHR = $.ajax({
                        url: '{{ route('admin.api.getCategories') }}',
                        method: 'GET',
                        dataType: 'json',
                        dataSrc: "",
                        data: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return '<label class="toggle-switch toggle-switch-sm" for="status_' +
                                ...
                                ', \'status\',\'post_categories\')" ' + checked + '>' +
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            console.log(data);
                            var checked = (data == 1) ? 'checked' : '';
                            return '<label class="toggle-switch toggle-switch-sm" for="view_home_' +
                                row.id + '">' +
                                '<input type="checkbox" class="toggle-switch-input" id="view_home_' +
                                row.id + '" onclick="updateStatus(' + row.id +
                                ', \'view_home\',\'post_categories\')" ' + checked + '>' +
                                '<span class="toggle-switch-label"><span class="toggle-switch-indicator"></span></span>' +
                                '</label>';
                        }
                    },
