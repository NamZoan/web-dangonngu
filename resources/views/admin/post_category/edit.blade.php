...
@section('content')
    <main id="content" role="main" class="main">
        {!! html()->form('POST', route('admin_post_category_update', $category->id))->class('validasi')->attributes(['novalidate'])->open() !!}
        <!-- Content -->
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                <li class="breadcrumb-item"><a class="breadcrumb-link"
                                        href="{{ route('admin_post_category_index') }}">Danh mục</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="card mb-3 mb-lg-5">
                                    <div class="card-header">
                                        ...
                                        <div class="col-md-10">
                                            {!! html()->input('hidden', 'image', $category->image)->class('form-control')->id('file-name')->placeholder('Đường dẫn link ảnh')->aria('label', 'Đường dẫn link ảnh') !!}
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div id="attachFilesNewProjectLabel"
                                            class="dropzone-custom custom-file-boxed dz-clickable">
                                            <img class="" src="{!! $category->image ? asset($category->image) : asset('userfiles/noimage.jpg') !!}" id="file-url"
                            ...
                            <div class="card col-lg-5">
                                <div class="card-body">
                                    ...
                                    {!! html()->input('text', 'slug', $category->slug)->class('form-control')->id('slug')->placeholder('slug')->aria('label', 'slug')->attributes(['required', 'onchange' => 'updateSlug(' . $category->id . ',null,this.value."post_categories")']) !!}
                                    ...
                                    <div class="row">
                                        {!! html()->div()->class('form-group col-6')->open() !!}
                                        <label class="toggle-switch" for="status">
                                            ...
                                            <span class="col-4 col-sm-3">
                                                {!! html()->checkbox('status', $category->status)->class('toggle-switch-input')->id('status') !!}
                                        ...
                                        {!! html()->div()->close() !!}
                                        {!! html()->div()->class('form-group col-6')->open() !!}
                                        <label class="toggle-switch" for="view_home">
                                            <span class="col-8 col-sm-9 toggle-switch-content">
                                                <span class="text-dark">Trang chủ</span>
                                            </span>
                                            <span class="col-4 col-sm-3">
                                                {!! html()->checkbox('view_home', $category->view_home)->class('toggle-switch-input')->id('view_home') !!}
                                                <span class="toggle-switch-label ml-auto">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </span>
                                    ...
                                    {!! html()->select('rel', ['dofollow' => 'dofollow', 'nofollow' => 'nofollow'], $category->rel)->class('form-control')->id('rel') !!}
                                    {!! html()->div()->close() !!}

                                    {!! html()->div()->class('form-group')->open() !!}
                                    {!! html()->label('Target')->for('target') !!}
                                    {!! html()->select('target', ['_self' => '_self', '_blank' => '_blank'], $category->target)->class('form-control')->id('target') !!}
                                    {!! html()->div()->close() !!}
                                ...
                                <div class="tab-pane fade show {!! app()->getLocale() == $val->abbr ? 'active' : '' !!}" id="lang_{{ $val->abbr }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="card mb-3 mb-lg-5">
                                                <div class="card-header">
                                                    <h4 class="card-header-title">Thông tin danh mục bài viết</h4>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'name[' . $val->abbr . ']', $category->getTranslation('name', $val->abbr))->class('form-control')->id('name')->placeholder('Tên danh mục')->aria('label', 'Tên danh mục')->attributes(['required', 'onchange' => 'updateSlug(' . $category->id . ",this.value,null,'post_categories')"]) !!}
                                                    {!! html()->div()->class('invalid-tooltip')->open() !!}
                                        ...
                                        <div class="col-lg-5">
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_title[' . $val->abbr . ']', $category->getTranslation('meta_title', $val->abbr))->class('form-control')->id('meta_title')->placeholder('meta_title')->aria('label', 'meta_title') !!}
                                                    {!! html()->div()->class('input-group-append') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_keyword[' . $val->abbr . ']', $category->getTranslation('meta_keyword', $val->abbr))->class('form-control')->id('meta_keyword')->placeholder('meta_keyword')->aria('label', 'meta_keyword') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_description[' . $val->abbr . ']', $category->getTranslation('meta_description', $val->abbr))->class('form-control')->id('meta_description')->placeholder('meta_description')->aria('label', 'meta_description') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <label class="input-label">Mô tả danh mục<span
                                                    class="input-label-secondary">(không
                                                    bắt
                                                    buộc)</span></label>
                                            {!! html()->div()->class('quill-custom')->open() !!}
                                            {!! html()->textarea('description[' . $val->abbr . ']', $category->getTranslation('description', $val->abbr))->class('form-control')->id('description[' . $val->abbr . ']')->rows(10) !!}
                                            {!! html()->div()->close() !!}
                                        </div>
