...
@section('content')
    <main id="content" role="main" class="main">
        {!! html()->form('POST', route('admin_information_update', $information->id))->class('validasi')->attributes(['novalidate'])->open() !!}
        <!-- Content -->
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Sửa thông tin</h1>
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="card col-lg-5">
                                ...
                                {!! html()->input('text', 'slug',$information->slug)->class('form-control')->id('slug')->placeholder('slug')->aria('label', 'slug')->attributes(['required', 'onchange' => 'updateSlug(null,null,this->value,"information")']) !!}
                                ...
                                <label class="toggle-switch" for="status">
                                    ...
                                    <span class="col-4 col-sm-3">
                                        {!! html()->checkbox('status', $information->status)->class('toggle-switch-input')->id('status') !!}
                                ...
                                <label class="toggle-switch" for="view_header">
                                    ...
                                    <span class="col-4 col-sm-3">
                                        {!! html()->checkbox('view_header', $information->view_header)->class('toggle-switch-input')->id('view_header') !!}
                                        <span class="toggle-switch-label ml-auto">
                                            <span class="toggle-switch-indicator"></span>
                                        </span>
                                    </span>
                                ...
                                <label class="toggle-switch" for="view_footer">
                                    ...
                                    <span class="col-4 col-sm-3">
                                        {!! html()->checkbox('view_footer', $information->view_footer)->class('toggle-switch-input')->id('view_footer') !!}
                                        <span class="toggle-switch-label ml-auto">
                                            <span class="toggle-switch-indicator"></span>
                                        </span>
                                    </span>
                                ...
                                <div class="tab-pane fade show {!! app()->getLocale() == $val->abbr ? 'active' : '' !!}" id="lang_{{ $val->abbr }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'name[' . $val->abbr . ']', $information->getTranslation('name', $val->abbr))->class('form-control')->id('name')->placeholder('Tên danh mục')->aria('label', 'Tên danh mục')->attributes(['required', 'onchange' => 'updateSlug(' . $information->id . ",this.value,null,'information')"]) !!}
                                                    {!! html()->div()->class('invalid-tooltip')->open() !!}
                                        ...
                                        <div class="col-lg-5">
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_title[' . $val->abbr . ']', $information->getTranslation('meta_title', $val->abbr))->class('form-control')->id('meta_title')->placeholder('meta_title')->aria('label', 'meta_title') !!}
                                                    {!! html()->div()->class('input-group-append') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_keyword[' . $val->abbr . ']', $information->getTranslation('meta_keyword', $val->abbr))->class('form-control')->id('meta_keyword')->placeholder('meta_keyword')->aria('label', 'meta_keyword') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_description[' . $val->abbr . ']', $information->getTranslation('meta_description', $val->abbr))->class('form-control')->id('meta_description')->placeholder('meta_description')->aria('label', 'meta_description') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            {!! html()->textarea('description[' . $val->abbr . ']', $information->getTranslation('description', $val->abbr))->class('form-control')->id('description[' . $val->abbr . ']')->rows(10) !!}
                                            {!! html()->div()->close() !!}
                                        </div>
