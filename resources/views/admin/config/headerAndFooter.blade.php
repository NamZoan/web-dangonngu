...
@section('content')
    <main id="content" role="main" class="main">
        {!! html()->form('POST', route('admin_config_headerAndFooter_update'))->class('validasi')->attributes(['novalidate'])->open() !!}
        <!-- Content -->
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Cấu hình Header và Footer</h1>
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
