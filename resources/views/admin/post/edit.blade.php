...
@section('content')
    <main id="content" role="main" class="main">
        {!! html()->form('POST', route('admin_post_update', $post->id))->class('validasi')->attributes(['novalidate'])->open() !!}
        <!-- Content -->
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="card mb-3 mb-lg-5">
                                    <div class="card-header">
                                        ...
                                        <div class="col-md-10">
                                            {!! html()->input('hidden', 'image', $post->image)->class('form-control')->id('file-name')->placeholder('Đường dẫn link ảnh')->aria('label', 'Đường dẫn link ảnh') !!}
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div id="attachFilesNewProjectLabel"
                                            class="dropzone-custom custom-file-boxed dz-clickable">
                                            <img class="" src="{!! $post->image ? asset($post->image) : asset('userfiles/noimage.jpg') !!}" id="file-url"
                                ...
                                <div class="row mb-9 mb-lg-7">
                                    ...
                                    <label class="toggle-switch" for="status">
                                        ...
                                        <span class="col-4 col-sm-3">
                                            {!! html()->checkbox('status', $post->status)->class('toggle-switch-input')->id('status') !!}
                            ...
                            <div class="card col-lg-5">
                                <div class="card-body">
                                    ...
                                    {!! html()->input('text', 'slug', $post->slug)->class('form-control')->id('slug')->placeholder('slug')->aria('label', 'slug')
                                    ->attributes(['required','onchange' => 'updateSlug('.$post->id.',null,this.value,"posts")']) !!}
                                    ...
                                    {!! html()->select('rel', ['dofollow' => 'dofollow', 'nofollow' => 'nofollow'], $post->rel)->class('form-control')->id('rel') !!}
                                    {!! html()->div()->close() !!}

                                    {!! html()->div()->class('form-group')->open() !!}
                                    {!! html()->label('Target')->for('target') !!}
                                    {!! html()->select('target', ['_self' => '_self', '_blank' => '_blank'], $post->target)->class('form-control')->id('target') !!}
                                    {!! html()->div()->close() !!}
                                ...
                                <div class="tab-pane fade show {!! app()->getLocale() == $val->abbr ? 'active' : '' !!}" id="lang_{{ $val->abbr }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'name[' . $val->abbr . ']', $post->getTranslation('name', $val->abbr))->class('form-control')->id('name')->placeholder('Tên bài viết')->aria('label', 'Tên bài viết')
                                                    ->attributes(['required', 'onchange' => "updateSlug(".$post->id.",this.value,null'posts')"]) !!}
                                                    {!! html()->div()->class('invalid-tooltip')->open() !!}
                                        ...
                                        <div class="col-lg-5">
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_title[' . $val->abbr . ']', $post->getTranslation('meta_title', $val->abbr))->class('form-control')->id('meta_title')->placeholder('meta_title')->aria('label', 'meta_title') !!}
                                                    {!! html()->div()->class('input-group-append') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_keyword[' . $val->abbr . ']', $post->getTranslation('meta_keyword', $val->abbr))->class('form-control')->id('meta_keyword')->placeholder('meta_keyword')->aria('label', 'meta_keyword') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'meta_description[' . $val->abbr . ']', $post->getTranslation('meta_description', $val->abbr))->class('form-control')->id('meta_description')->placeholder('meta_description')->aria('label', 'meta_description') !!}
                                                    {!! html()->div()->close() !!}
                                                    {!! html()->div()->close() !!}
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            {!! html()->textarea('description[' . $val->abbr . ']', $post->getTranslation('description', $val->abbr))->class('form-control')->id('description[' . $val->abbr . ']')->rows(10) !!}
                                            {!! html()->div()->close() !!}
                                        </div>
