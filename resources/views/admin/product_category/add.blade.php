...
@section('content')
    <main id="content" role="main" class="main">
        {!! html()->form('POST', route('admin_product_category_store'))->class('validasi')->attributes(['novalidate'])->open() !!}
        <!-- Content -->
                        ...
                        <div class="row">
                            ...
                            <div class="card col-lg-5">
                                <div class="card-body">
                                    ...
                                    {!! html()->input('text', 'slug')->class('form-control')->id('slug')->placeholder('slug')->aria('label', 'slug')->attributes(['required', 'onchange' => 'updateSlug(null,null,this.value,"product_categories")']) !!}
                                        ...
                                        <div class="col-lg-7">
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'name[' . $val->abbr . ']')->class('form-control')->id('name')->placeholder('Tên danh mục')->aria('label', 'Tên danh mục')->attributes(['required', 'onchange' => 'updateSlug(null,this.value,null,"product_categories")']) !!}
                                                    {!! html()->div()->class('invalid-tooltip')->open() !!}
