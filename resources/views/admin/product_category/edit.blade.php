...
@section('content')
    <main id="content" role="main" class="main">
        {!! html()->form('POST', route('admin_product_category_update', $category->id))->class('validasi')->attributes(['novalidate'])->open() !!}
        <!-- Content -->
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                <li class="breadcrumb-item"><a class="breadcrumb-link"
                                        href="{{ route('admin_product_category_index') }}">Danh mục</a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-3 mb-lg-5">
                                    ...
                                    <div class="card-body">
                                        <div id="attachFilesNewProjectLabel"
                                            ...
                                            {!! html()->img($category->image ? asset($category->image) : asset('userfiles/noimage.jpg'))->class('')->id('file-url')->alt('Image Description') !!}
                            ...
                            <div class="card col-lg-5">
                                <div class="card-body">
                                    ...
                                    {!! html()->input('text', 'slug', $category->slug)->class('form-control')->id('slug')->placeholder('slug')
                                    ->attributes(['required','onchange'=>'updateSlug('.$category->id.',null,this.value,"product_categories")'])->aria('label', 'slug') !!}
                                    ...
                                    <label class="toggle-switch" for="status">
                                        ...
                                        <span class="col-4 col-sm-3">
                                            {!! html()->checkbox('status', $category->status == 1 ? 1 : 0)->class('toggle-switch-input')->id('status') !!}
                        ...
                        <div class="tab-content" id="myTabContent">
                            @foreach ($languages as $key => $val)
                                <div class="tab-pane fade show {!! app()->getLocale() == $val->abbr ? 'active' : '' !!}" id="lang_{{ $val->abbr }}"
                                    role="tabpanel" aria-labelledby="{{ $val->abbr }}-tab" data-lang="{{$val->abbr}}">
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="card mb-3 mb-lg-5">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! html()->div()->class('input-group')->open() !!}
                                                    {!! html()->input('text', 'name[' . $val->abbr . ']', $category->getTranslation('name', $val->abbr))->class('form-control')->id('name')->placeholder('Tên danh mục')->aria('label', 'Tên danh mục')
                                                    ->attributes(['required','onchange'=>'updateSlug('.$category->id.',this.value,null,"product_categories")']) !!}
                                                    {!! html()->div()->class('invalid-tooltip')->open() !!}
